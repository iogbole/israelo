...
-   In the example code beloe, my analysis shows a performance gain of ~ `6.92%` in compute efficiency. I wasn't expecting such improvement considering it's only a small JSON unmarshalling cod. The potential savings in your production could be more. 
