...
-   In the example code below, my analysis shows a performance gain of ~ `6.92%` in compute efficiency. I wasn't expecting such improvement considering it's only a small JSON unmarshalling code. The potential savings in your production environment could be even greater 
